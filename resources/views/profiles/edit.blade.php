				...
				<div class="mdl-card card-wide" style="width:100%;" itemscope itemtype="http://schema.org/Person">
					<div class="mdl-user-avatar">
						<div id="avatar_selector_avatar" class="avatar-selecter @if($user->profile->avatar_status == 0) active-avatar-selecter @endif">
							<img src="{{ asset('images/spiderman_avatar.png') }}" alt="{{ $user->name }}" class="user-avatar">
					...
					<div id="user_profile_header" class="mdl-card__title mdl-color--primary mdl-color-text--white" @if ($user->profile->user_profile_bg != NULL) style="background: url('{{ asset('images/backgrounds/patterns/maia.png') }}');" @endif>
